...
$(document).ready(function() {
    ...
    //     }
      ...
      let promise = new Promise(function(resolve, reject) {
        ...
        let url = `https://api.betterdoctor.com/2016-03-01/doctors?name=bob&location=45.5155%2C%20-122.6793%2C%20100&user_location=45.5155%2C%20-122.6793&skip=0&limit=10&user_key=${process.env.apiKey}`;
